...
<div class="modal-body">
	...
	<div class="mb-3">
		...
		<input class="form-control" type="number" id="tiempoTotal"
			name="tiempoTotal" required value="${atraccion.tiempoTotal}"></input>
		<div class="invalid-feedback">
	...
	<div class="mb-3">
		...
		<input class="form-control" type="number" id="cupoInicial"
			name="cupoInicial" required value="${atraccion.cupoInicial}"></input>
		<div class="invalid-feedback">
	...
	<div class="mb-3">
		<label for="Tipo_Atraccion"
			class='col-form-label ${atraccion.errors.get("tipoAtraccion") != null ? "is-invalid" : "" }'>Tipo
			de atracción:</label> <input class="form-control" type="text"
			id="Tipo_Atraccion" name="Tipo_Atraccion" required
			value="${atraccion.tipoAtraccion}"></input>
		<div class="invalid-feedback">
	...
	<div class="mb-3">
		...
		<input class="form-control" type="text" id="descripcion"
			name="descripcion" required value="${atraccion.descripcion}"></input>
		<div class="invalid-feedback">
