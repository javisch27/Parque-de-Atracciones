...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
	<div class="container">
		<a class="navbar-brand" href="/LaFuerza-Turismo/index.jsp">Turismo en la Fuerza</a>
		...
		<div class="collapse navbar-collapse" id="navbarCollapse">
			...
			<ul class="navbar-nav me-auto mb-2 mb-md-0">
				<li class="nav-item"><a class="nav-link active"
					aria-current="page" href="/LaFuerza-Turismo/promociones/index.do">Promociones</a></li>
			</ul>
			<ul class="navbar-nav">
				<li class="nav-item dropdown">
					...
					<ul class="dropdown-menu dropdown-menu-end"
						...
						<li><a class="dropdown-item disabled" style="color: black;">
							<i title="monedas" style="color: gold;" class="bi bi-coin"></i> <c:out value="${usuario.presupuestoDisponible}"></c:out>
						</a></li>
						<li><a class="dropdown-item disabled" style="color: black;">
							<i title="tiempo" style="color: blue;" class="bi bi-clock-fill"></i> <c:out value="${usuario.tiempoDisponible}h"></c:out>
						</a></li>
						<li><hr class="dropdown-divider"></li>
						<li><a href="/LaFuerza-Turismo/logout" class="dropdown-item">Salir</a></li>
					</ul>
				</li>
			</ul>
		</div>
